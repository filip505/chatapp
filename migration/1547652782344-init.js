...
init1547652782344.prototype.up = async function (qr) {
   qr.query('create table person (id uuid, email varchar UNIQUE, image varchar, number varchar UNIQUE, key varchar, firstName varchar, lastName varchar, password varchar,  PRIMARY KEY(id));');
